...
def left_projectivity(left_proj, right):
    ...
    if left_proj:
        # Apply the current (0th) dimension of the projectivity function to the
        # right argument:
...
def interpret(tree, lexicon, projectivity, fa=fa_left_first):
    ...
    # For branching cases.
        ...
        raise Exception(
            "We have no provision for interpreting branching nodes greater than 2.")
...
projectivity[
    'some'] = [{EQ: EQ, FOR: FOR, REV: REV, NEG: COV, ALT: INDY, COV: COV, INDY: INDY},
               {EQ: EQ, FOR: FOR, REV: REV, NEG: COV, ALT: INDY, COV: COV, INDY: INDY}]

projectivity[
    'all'] = [{EQ: EQ, FOR: REV, REV: FOR, NEG: ALT, ALT: INDY, COV: ALT,  INDY: INDY},
...
projectivity[
    'no'] = [{EQ: EQ, FOR: REV, REV: FOR, NEG: ALT, ALT: INDY, COV: ALT, INDY: INDY},
             {EQ: EQ, FOR: REV, REV: FOR, NEG: ALT, ALT: INDY, COV: ALT, INDY: INDY}]

projectivity[
    'most'] = [{EQ: EQ, FOR: INDY, REV: INDY, NEG: INDY, ALT: INDY, COV: INDY, INDY: INDY},
               {EQ: EQ, FOR: FOR, REV: REV, NEG: ALT, ALT: ALT, COV: INDY, INDY: INDY}]

projectivity[
    'not_all'] = [{EQ: EQ, FOR: FOR, REV: REV, NEG: COV, ALT: INDY, COV: COV, INDY: INDY},
                  {EQ: EQ, FOR: REV, REV: FOR, NEG: COV, ALT: COV, COV: INDY, INDY: INDY}]

projectivity[
    'not_most'] = [{EQ: EQ, FOR: INDY, REV: INDY, NEG: INDY, ALT: INDY, COV: INDY, INDY: INDY},
