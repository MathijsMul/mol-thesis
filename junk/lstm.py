...
class LSTM(nn.Module):
    ...
    def __init__(self, vocab, rels, word_dim, hidden_size, cpr_dim):
        ...
        self.lstm = nn.LSTM(self.word_dim, self.hidden_size, 1)
    ...
    def rnn_forward(self, input, size_batch):
        ...
        output, _ = self.lstm(batch_matrix) # output dim: (seq_len, batch, hidden_size * num_directions)
...
if False:
    ...
    net = LSTM(vocab, rels, word_dim=word_dim, hidden_size=hidden_size, cpr_dim=cpr_dim)
