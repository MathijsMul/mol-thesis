"""
plot sentence vectors and their negations as outputted by different models
"""
...
print('Nr. of points/sentences: ', str(len(idx_to_projection)))
print('Nr. of pairs: ', str(len(idx_to_projection) / 2))
...
for idx, pair in enumerate(relations):
    ...
    line = plt.plot([x1, x2], [y1, y2], color='black', lw=0.04,alpha=0.75)
...
plt.savefig('trntn-negated-unactivated5', format='png', dpi=500)
plt.show()
